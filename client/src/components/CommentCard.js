...
function CommentCard({comment}) {
    ...
    //         }
    //         console.log("Sending Like Data:", JSON.stringify(values, null, 2));
    ...
    //         const likeId = comment.likes.map(x => x.comment_liker.first_name)
    //         console.log(likeId)
    //     }
    // }

    // const handleLikeClick = () => {
    //     console.log('check if it this is triggered.')
    ...
    // if (!comment || !user) (return <p>Loading...</p>; )


    return (
        <div className='shoutout-card'>
             <Link className='link-comment-style'>
