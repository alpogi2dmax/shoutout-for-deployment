...
function CommentProvider({children}) {
    ...
    return (
        ...
        <CommentContext.Provider value={{comments, setComments, handleLogoutComments, updateComments, deleteComment, handleLike, handleReplyLikeComment, deleteReplyComment}}>
            {children}
